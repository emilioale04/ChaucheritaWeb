<%@ login.jsp contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div>
        <form action="" method="post">
            ...
            <div class="ds-flex align-center pd-y-16">
                ...
                <input type="password" class="input text-base" id="clave" name="clave" placeholder="Clave" required><br>
            </div>
