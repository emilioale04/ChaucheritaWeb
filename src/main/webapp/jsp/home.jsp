    ...
    <div class="main-content">
        <section class="font-primary pd-t-40 pd-x-40">
            ...
            <div class="form-group pd-y-16 pd-x-24 bg-light border-light">
                <label for="filtro-cuentas" class="font-primary text-dark text-base pd-b-8">Filtrar por nombre:</label>
                <input
                        type="text"
                        id="filtro-cuentas"
                        class="pd-8 border-light text-base text-dark font-primary"
